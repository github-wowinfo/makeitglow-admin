...
const EXAMPLE_DATA: OrderTableItem[] = [
  { SrNo: 1, Customer: 'ABC', ShippingContact: 9876543210, OrderInfo: 'Ordered', PaidAmount: 200, PaymentStatus: 'Paid', Action: '' },
];
  ...
  private getSortedData(data: OrderTableItem[]): OrderTableItem[] {
    ...
    return data.sort((a, b) => {
      ...
      switch (this.sort?.active) {
        ...
        case 'ShippingContact': return compare(+a.ShippingContact, +b.ShippingContact, isAsc);
        case 'OrderInfo': return compare(+a.OrderInfo, +b.OrderInfo, isAsc);
        case 'PaidAmount': return compare(+a.PaidAmount, +b.PaidAmount, isAsc);
