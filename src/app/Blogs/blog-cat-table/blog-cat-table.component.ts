...
import { BlogCatTableDataSource, BlogCatTableItem } from './blog-cat-table-datasource';

@Component({
  selector: 'app-blog-cat-table',
  templateUrl: './blog-cat-table.component.html',
  styleUrls: ['./blog-cat-table.component.scss']
})
export class BlogCatTableComponent implements AfterViewInit {
  @ViewChild(MatPaginator) paginator!: MatPaginator;
  @ViewChild(MatSort) sort!: MatSort;
  @ViewChild(MatTable) table!: MatTable<BlogCatTableItem>;
  blogCat: any = [];
