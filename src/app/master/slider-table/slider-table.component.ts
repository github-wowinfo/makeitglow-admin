...
import { SliderTableDataSource, SliderTableItem } from './slider-table-datasource';
...
export class SliderTableComponent implements AfterViewInit {
  @ViewChild(MatPaginator) paginator!: MatPaginator;
  @ViewChild(MatSort) sort!: MatSort;
  @ViewChild(MatTable) table!: MatTable<SliderTableItem>;
  dataSource: SliderTableDataSource;

  /** Columns displayed in the table. Columns IDs can be added, removed, or reordered. */
  displayedColumns = ['id', 'name'];

  constructor() {
    this.dataSource = new SliderTableDataSource();
  }
