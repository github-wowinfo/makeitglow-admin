...
export class CountryTableDataSource extends DataSource<CountryTableItem> {
  data: CountryTableItem[] = EXAMPLE_DATA;
   ...
   */
  private getPagedData(data: CountryTableItem[]): CountryTableItem[] {
    if (this.paginator) {
   ...
   * this would be replaced by requesting the appropriate data from the server.
   */
  private getSortedData(data: CountryTableItem[]): CountryTableItem[] {
